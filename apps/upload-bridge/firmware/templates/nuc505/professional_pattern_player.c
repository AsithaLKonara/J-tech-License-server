/**
 * Professional NUC505 LED Pattern Player - Upload Bridge Template
 * 
 * Full professional-grade pattern player with all advanced features
 * Optimized for NUC505 with 128KB flash and 32KB RAM
...
#define MAX_LEDS 300  // Optimized for NUC505 memory (128KB flash, 32KB RAM)
...
// Speed keyframes (max 16 keyframes for NUC505)
...
float apply_brightness_curve(float value, uint8_t curve_type) {
    ...
    switch (curve_type) {
        ...
        case BRIGHTNESS_CURVE_GAMMA_CORRECTED:
            // Full gamma correction for NUC505
...
void ws2812_send_byte(uint8_t byte) {
    // NUC505 WS2812 bit-banging implementation (optimized for 48MHz)
...
void delay_ms(uint32_t ms) {
    // Simple delay loop for NUC505 at 48MHz
