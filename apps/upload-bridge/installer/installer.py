...
User flow: Install → Launch
- Copies UploadBridge.exe to install directory with progress bar
- Launches the app (login happens in app on first launch)
"""
...
class InstallerDialog(QDialog):
    ...
    def on_copy_finished(self, target: Path):
        ...
        QMessageBox.information(self, "Installed", "Installation completed. You can now launch Upload Bridge. Login will be required on first launch.")
