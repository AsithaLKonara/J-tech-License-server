    ...
    "properties": {
        ...
        "matrix": {
            ...
            "properties": {
                ...
                "irregular_shape_enabled": {
                    "type": ["boolean", "null"],
                    "description": "Whether irregular shape is enabled"
                },
                "active_cell_coordinates": {
                    "type": ["array", "null"],
                    "description": "Currently active cell coordinates"
                },
                ...
                "background_image_scale": {
                    "type": ["number", "null"],
                    "description": "Background image scale factor"
                },
                "background_image_offset_x": {
                    "type": ["number", "null"],
                    "description": "Background image X offset"
                },
                "background_image_offset_y": {
                    "type": ["number", "null"],
                    "description": "Background image Y offset"
                }
            },
