...
class Frame:
    ...
    is_baked: bool = False  # True if frame was generated from automation (should not be re-automated)
    source_frame_id: Optional[int] = None  # Original frame index that this was baked from (if baked)
