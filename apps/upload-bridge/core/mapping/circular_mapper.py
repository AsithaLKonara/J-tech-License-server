...
class CircularMapper:
    ...
    @staticmethod
    def generate_multi_ring_mapping(metadata) -> List[Tuple[int, int]]:
        """
    ...
    @staticmethod
    def generate_radial_ray_mapping(metadata) -> List[Tuple[int, int]]:
        """
    ...
    @staticmethod
    def generate_custom_position_mapping(metadata) -> List[Tuple[int, int]]:
        """
    ...
    @staticmethod
    def generate_mapping_table(metadata) -> List[Tuple[int, int]]:
        """
    ...
    @staticmethod
    def grid_to_led_index(x: int, y: int, metadata) -> Optional[int]:
        """
    ...
    @staticmethod
    def led_index_to_grid(led_idx: int, metadata) -> Optional[Tuple[int, int]]:
        """
    ...
    @staticmethod
    def get_led_count_for_layout(metadata) -> int:
        """
    ...
    @staticmethod
    def validate_mapping_table(metadata) -> Tuple[bool, Optional[str]]:
        """
    ...
    @staticmethod
    def is_mapped(x: int, y: int, metadata) -> bool:
        """
    ...
    @staticmethod
    def ensure_mapping_table(metadata) -> bool:
        """
